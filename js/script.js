...
for (var _a = 0, cd_1 = cd; _a < cd_1.length; _a++) {
    var indexCd = cd_1[_a];
...
for (var _b = 0, dvd_1 = dvd; _b < dvd_1.length; _b++) {
    var indexDvd = dvd_1[_b];
...
for (var _c = 0, comic_1 = comic; _c < comic_1.length; _c++) {
    var indexComic = comic_1[_c];
